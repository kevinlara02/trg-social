// Mints a Google OAuth access token from a service-account key (env
// GOOGLE_SA_JSON), used by the GA4 traffic + Sheets messages functions.
// Pure Node crypto (no extra dependencies). Token cached ~50 minutes.
